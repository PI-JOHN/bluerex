			...
			<div class="col-lg-6 mb-5">
				...
				<ul class="nav nav-pills" id="myTab" role="tablist">
					...
					<li class="nav-item" role="presentation">
						<a class="nav-link rounded-pill <?php if(!$i) echo 'active'; ?>" id="<?php echo $post->post_name ?>-tab" data-toggle="tab" href="#<?php echo $post->post_name ?>"
						   role="tab"
				...
				<div class="tab-content" id="myTabContent">
					...
					<div class="tab-pane fade show <?php if(!$k) echo 'active'; ?>" id="<?php echo $item['post_name']; ?>" role="tabpanel"
						 aria-labelledby="<?php echo $item['post_name']; ?>-tab">
						<?php echo $item['content']; ?>
                        <p><a href="<?php echo $item['url']; ?>" class="btn btn-pink btn-shadow"><?= __('Read more','bluerex') ?></a></p>
					</div>
                    <?php endforeach; ?>
				</div>
			</div>
			...
			<div class="col-lg-6">
				...
				<div class="embed-responsive embed-responsive-16by9 mt-5">
					<iframe id="videoPlayer" class="embed-responsive-item"
							src="<?= $video ?>?enablejsapi=1&amp;html5=1&amp;rel=0&amp;&amp;showinfo=0"
