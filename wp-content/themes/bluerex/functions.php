...
function bluerex_scripts() {
	...
	wp_enqueue_style( 'bluerex-bootstrap-css', get_template_directory_uri() . '/assets/bootstrap/css/bootstrap.min.css', array(), _S_VERSION );
	wp_enqueue_style( 'bluerex-googlefonts', "https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;700&family=Poppins:wght@600;700&display=swap", array(), _S_VERSION );
//	wp_enqueue_style( 'bluerex-fontawesome-css', "https://kit.fontawesome.com/c9af01b590.js", array(), _S_VERSION );
	...
	wp_enqueue_script('bluerex-fontawesome-js',"https://kit.fontawesome.com/c9af01b590.js",array(),'',true);
	wp_enqueue_script('bluerex-bootstrap-js',get_template_directory_uri().'/assets/bootstrap/js/bootstrap.min.js',array(),'',true);
	wp_enqueue_script('bluerex-baguette-js',get_template_directory_uri().'/assets/js/baguetteBox.min.js',array(),'',true);
